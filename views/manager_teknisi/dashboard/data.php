...
$stats_proses = mysqli_fetch_assoc(mysqli_query($host, "SELECT COUNT(*) as total FROM laporan_detail WHERE id_manager_teknisi = '$id_log' AND tanggal_penugasan IS NOT NULL"))['total'];
...
$urgent_query = mysqli_query($host, "
    ...
    AND ld.tanggal_penugasan IS NOT NULL
        ...
        <main class="flex-1 overflow-auto bg-kf-cream/50 p-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-kf-sky/10">
                    ...
                    <p class="text-3xl font-bold text-kf-dark">0</p>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-kf-sky/10">
                    <div class="flex items-center gap-3 mb-2">
