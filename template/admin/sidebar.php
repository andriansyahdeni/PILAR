...
<aside class="sidebar no-print">
  ...
  <div class="sidebar-fixed-bottom">
    ...
    <button type="button" onclick="confirmAction('logout')" class="sidebar-logout" style="border: none; background: none; cursor: pointer; display: flex; align-items: center; gap: 8px; width: 100%;">
