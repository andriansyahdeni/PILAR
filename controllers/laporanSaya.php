...
if (isset($_POST['tambah'])) {
    ...
    if ($execute) {
        ...
        // Set pesan otomatis dengan prefix tag kustom [SISTEM]
        $pesan_sistem = "[SISTEM] Hai " . $nama_user . ", terimakasih ya sudah melaporkan. Status laporan kamu saat ini adalah \"menunggu\". Mohon ditunggu, tim admin akan segera memeriksa laporanmu! 😊";
        kirimPesanOtomatisSistem($host, $id_laporan_baru, $id_pelapor, $pesan_sistem);
